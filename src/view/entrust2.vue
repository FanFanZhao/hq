...
export default {
    ...
    data (){
        return{
            ...
            more01:'加载更多',
            loading:false,
            urlList:[{title:"当前委托",url:'transaction_in'},{title:"历史委托",url:"transaction_complete"}],
            ...
            data:{
             ...
             headers: {'Authorization':  this.token}
                ...
                if(url=="transaction_in"){
                   ...
                   if(page==1){
                       console.log('-----------------')
                       this.enList = res.message.list;
                   }else{
                       var newEist = res.message.list;
                       console.log()
                       if(newEist.length<=0){
                           this.more="没有更多数据了...";
                           return;
        ...
        getHistory(){
            ...
            data:{
             ...
             headers: {'Authorization':  this.token}
                ...
                this.loading=false;
                 if(page01==1){
                       this.hisList = res.data.message.list
                   }else{
                       var newhist = res.data.message.list;
                       if(newhist.length<=0){
                           this.more="没有更多数据了...";
                           return;
                       }else{
