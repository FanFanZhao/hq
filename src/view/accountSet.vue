    ...
    <div  class="account-main">
        <div  class="clear mb50">
            ...
            <div  class="fl ml30  mt20">
                <p  class="ft16 fColor1">{{accounts}}</p>
                <!-- <div  class="bar-bottom">
                    <div  class="bar-top" style="width: 25%;"></div>
                </div> -->
                <p  class="fColor2 ft14">UID:{{uid}}</p>
        ...
        <ul >
            ...
            <li>
                ...
                <p  class="fl">{{moneypwd}} </p>
                <span  class="fr base ml25 mouseDefault"></span>
                <span  class="fr base mouseDefault"></span>
                <router-link class="fr base" to="/bindmpwd" v-if="moneypwd == '未绑定'">去绑定</router-link>
                <span class="fr base" v-else>已绑定</span>
            </li>
        ...
        userInfo(){
            this.$http({
                ...
                if(res.data.type == 'ok'){
                    ...
                    this.accounts=res.data.message.account;
